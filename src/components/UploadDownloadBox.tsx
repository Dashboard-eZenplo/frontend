const UploadDownloadBox = () => {
    return (
        <div className="flex flex-col items-center">
            <div className="border border-black rounded-lg h-[400px] lg:h-[450px] w-full lg:w-[1300px] flex flex-col items-center justify-between bg-white p-4">
                <div className="flex flex-col items-center">
                    <p className="text-[20px] md:text-[20px] lg:text-[40px] font-semibold mb-1">
                        Arraste & Solte arquivos aqui
                    </p>
                    <p className="text-[16px] md:text-[23px] lg:text-[28px] text-center" style={{ color: '#828282' }}>
